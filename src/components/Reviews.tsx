    ...
    <section id="reviews" className="border-t border-[#2a2a4a] bg-grid px-4 py-24">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {reviews.map((r, i) => (
            <div key={i} className="card-scale-in flex flex-col rounded-lg border border-[#2a2a4a] bg-black/30 backdrop-blur-sm p-6 transition-all hover:border-[#ff00ff]/50">
