    ...
    >
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <a
          ...
          className="card-glass card-glass-pulse mb-10 inline-flex items-center gap-3 rounded-lg border border-[#2a2a4a] bg-black/30 backdrop-blur-sm px-8 py-4 text-lg font-bold text-[#00ffff] transition-all hover:border-[#ff00ff]/50"
        >
