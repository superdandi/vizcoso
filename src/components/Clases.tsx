...
export default function Clases() {
  return (
    <section id="clases" className="scroll-mt-20 border-t border-[#2a2a4a] bg-grid px-4 py-24">
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="overflow-hidden rounded-lg border border-[#2a2a4a]">
          {clasesMusica.map((c, i) => (
            <div
              key={i}
              className={`card-fade-left flex items-center justify-between backdrop-blur-sm px-6 py-4 ${
